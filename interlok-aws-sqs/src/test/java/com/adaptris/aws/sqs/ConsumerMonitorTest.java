...
public class ConsumerMonitorTest {
  ...
  public void testJmxFactory() throws Exception {
    WorkflowManager workflowManager = Mockito.mock(WorkflowManager.class);
    AmazonSQSConsumer consumer = new AmazonSQSConsumer(new ConfiguredConsumeDestination("myQueue"));
    AmazonSQSConsumer consumerWithId = new AmazonSQSConsumer(new ConfiguredConsumeDestination("myQueue"));

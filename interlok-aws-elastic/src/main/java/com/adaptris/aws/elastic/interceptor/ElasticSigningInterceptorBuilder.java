 ...
 * </p>
 * 
 * @config aws-elastic-signing-interceptor
 */
@XStreamAlias("aws-elastic-signing-interceptor")
@AdapterComponent
@ComponentProfile(
...
@NoArgsConstructor
public class ElasticSigningInterceptorBuilder implements RequestInterceptorBuilder {
  ...
  public ElasticSigningInterceptorBuilder withRegion(String region) {
    setRegionName(region);
    return this;
  }

  public ElasticSigningInterceptorBuilder withService(String service) {
    setServiceName(service);
    return this;
  }

  public ElasticSigningInterceptorBuilder withCredentials(AWSCredentialsProviderBuilder creds) {
